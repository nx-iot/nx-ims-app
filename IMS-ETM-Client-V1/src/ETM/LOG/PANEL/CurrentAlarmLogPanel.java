...
public class CurrentAlarmLogPanel extends javax.swing.JPanel implements ActionListener, MouseListener
{
    ...
    public CurrentAlarmLogPanel(LogManagementIF LMIF)
    {
        this.LMIF = LMIF;
        initComponents();
        extendComponents();
    ...
    private void updateTable()
    {
        ...
        if (deviceStatusTabPane.getSelectedIndex() == 0)
        {
           Vector v = LMIF.MF.HDC.queryAll("SELECT "
                ...
                + "FROM alarm_current NATURAL JOIN error NATURAL JOIN device  "
