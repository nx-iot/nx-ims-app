...
public class AccountPanel extends javax.swing.JPanel implements ActionListener
{
    ...
    private static String defaultUserComboBox = "Select an username...";
    private static String defaultDepartComboBox = "Select a department...";

    public AccountPanel(UserManagementIF UMIF)
    {
        this.UMIF = UMIF;
    ...
    private void initComponents() {
            ...
            .addGroup(reportPanelLayout.createSequentialGroup()
                ...
                .addGroup(reportPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(reportPanelLayout.createSequentialGroup()
                        ...
                        .addComponent(phoneField, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE))
                    .addGroup(reportPanelLayout.createSequentialGroup()
                        .addComponent(emailLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(emailField, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)))
                .addContainerGap())
        );
            ...
            .addGroup(basicPanelLayout.createSequentialGroup()
                ...
                .addGroup(basicPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(basicPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(departmentField, javax.swing.GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE))
                    .addGroup(basicPanelLayout.createSequentialGroup()
                        .addComponent(addressLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(basicPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(addressField2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE)
                            .addComponent(addressField1, javax.swing.GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE))))
                .addContainerGap())
        );
        basicPanelLayout.setVerticalGroup(
            ...
            .addGroup(basicPanelLayout.createSequentialGroup()
                ...
                .addGap(12, 12, 12)
                .addGroup(basicPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(addressField1, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        picPanel.setMinimumSize(new java.awt.Dimension(105, 101));
        picPanel.setPreferredSize(new java.awt.Dimension(120, 101));
        ...
        userComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select an username..." }));

        userLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        userLabel1.setForeground(new java.awt.Color(0, 0, 153));
        userLabel1.setText("Department");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(departComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(departComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(userLabel1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(userComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGap(16, 16, 16)
                .addComponent(sectorTabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jLabel2.setMaximumSize(new java.awt.Dimension(3, 29));
        jLabel2.setMinimumSize(new java.awt.Dimension(3, 29));
        jLabel2.setPreferredSize(new java.awt.Dimension(3, 29));
        ...
        modifyButton.setToolTipText("Edit account");
        ...
        newButton.setToolTipText("Add new account");
    ...
    public void setDepartmentComboBox()
    {
        ...
        if (UMIF.MF.SD.permissionCrossDepartment.equals("1")) departComboBox.addItem("All");
    ...
    public void setUserComboBox()
    {
        ...
        userComboBox.addItem(defaultUserComboBox);
        Enumeration enu = null;
        String depart = (String) departComboBox.getSelectedItem();
        if (depart != null && !depart.equals(defaultDepartComboBox))
        {
            if(departComboBox.getSelectedItem().equals("All"))
            {
                enu = UMIF.MF.HDC.queryColumn("SELECT user_username FROM user;").elements();
            }
            else
            {
                enu = UMIF.MF.HDC.queryColumn("SELECT user_username FROM user WHERE depart_id = '"+HydeFormat.parseID(depart)+"';").elements();
            }
            while (enu != null && enu.hasMoreElements())
            {
                userComboBox.addItem(enu.nextElement());
            }
        }
    }
    ...
    public void clearInfo()
    {
        ...
        upper.setIcon(na);
        upperTime.setIcon(na);
        upperExtreme.setIcon(na);
        lower.setIcon(na);
        lowerTime.setIcon(na);
        lowerExtreme.setIcon(na);
        probe.setIcon(na);
        device.setIcon(na);
        connection.setIcon(na);
    ...
    {
        if (username.equals(defaultUserComboBox))
        {
            clearInfo();
            return;
        }
        ...
        if (u != null)
        {
            ...
            addressField1.setText((String) u.elementAt(7));
    ...
    private void setAccessTable(String username)
    {
        if (username.equals(defaultUserComboBox))
        {
            HydeDataSet.clearTable(accessTable);
            return;
        }
        ...
        String stmt = "SELECT user_username AS Username, log_name AS 'Type', user_log_timestamp AS 'Date-Time' "
                ...
                + "WHERE user_log.USER_USERNAME = '"+username+"' && true ORDER BY user_log.user_log_timestamp DESC;";
    ...
    {
        if (((String)userComboBox.getSelectedItem()).toLowerCase().equals("admin"))
        {
            JOptionPane.showMessageDialog(this, "You cannot delete Admin account...");
        }
        else if(!userComboBox.getSelectedItem().equals(defaultUserComboBox))
        {
            boolean success = UMIF.MF.HDC.customUpdate("DELETE FROM user WHERE user_username = '"+userComboBox.getSelectedItem()+"';");
            if (success)
            {
            ...
            {
                JOptionPane.showMessageDialog(this, "Account cannot be deleted...");
            }
        }
    }
    ...
    public javax.swing.JComboBox userComboBox;
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (src == modifyButton)
        {
            AccountModifyDialog AMD = new AccountModifyDialog(UMIF,AccountModifyDialog.ACCOUNT_PANEL);
        }
        else if (src == newButton)
        {
            AccountModifyDialog AMD = new AccountModifyDialog(UMIF,AccountModifyDialog.ACCOUNT_PANEL_NEW);
        }
        else if (src == deleteButton)
        {
            int inp = JOptionPane.showConfirmDialog(this, "You want to delete this account ?");
            if (inp == 0)
            {
                deleteAccount();
            }
        ...
        else if (src == userComboBox && userComboBox.getSelectedItem() != null)
        {
            setInfo((String) userComboBox.getSelectedItem());
            setAccessTable((String) userComboBox.getSelectedItem());
        }
    }
}
